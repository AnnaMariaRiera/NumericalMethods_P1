//Suma DECREIXENT double
#include<stdio.h>
#include<stdlib.h>

int main()
{
 double n; //Variable en precisió doble: és el nombre des del qual sumarem la sèrie en ordre decreixent de n fins a 1
 double s; //Variable en precisió doble: és el valor total de la suma.
 printf("Introdueix el numero de termes que vols sumar: \n");
 scanf("%lf",&n);
 
 int i; //Variable entera auxiliar per fer el bucle for
 double k; //Variable en precisió doble: és el nombre que s'està sumant a la sèrie
 ...
 //...........................................................................................
   {
     for(i=n;i>=1;i--)
	 {
		signe1=(-1)*signe1;
		k=k-1;
		s=s+signe1*(1./(k*k)); //Suma total, torna un valor en precisió doble
	 }
   }
  else
   { 
     for(i=n;i>=1;i--)
	 {
		signe2=(-1)*signe2;
		k=n-1;
		s=s+signe2*(1./(k*k)); //Suma total, torna un valor en precisió doble
	 }
   }
