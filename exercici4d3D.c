...
int main()
{
 ...
 double n, sum1,sum2,s; //Variables en precisió doble: n és el nombre desde el que sumarem la sèrie en ordre decreixent, sum1 una variable auxiliar per anar sumant tots els com si foren termes positius, sum2 suma dels negatius i s serà el valor total de la suma.
